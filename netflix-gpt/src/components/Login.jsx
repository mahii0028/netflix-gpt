  ...
  return (
    <div className="relative h-screen">
      ...
      <form
        ...
        className="absolute w-full max-w-sm sm:max-w-md p-6 sm:p-10 bg-black bg-opacity-75 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white rounded-md"
      >
